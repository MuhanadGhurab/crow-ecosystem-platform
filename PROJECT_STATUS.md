...
```text
Current Gate:
GHV.IMPLEMENTATION.0D-CLOSURE-01-AMENDMENT-01 — PASS — ACTIVE PRODUCT CODE AUTHORITY,
...
0E NOT STARTED
No Product Code changes in this Amendment
```

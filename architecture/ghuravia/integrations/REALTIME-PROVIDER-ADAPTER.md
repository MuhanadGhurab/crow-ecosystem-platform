...
| Field | Value |
|-------|-------|
| **Document ID** | GHV-ARCH-1D-INT-RT-001 |
| **Version** | 1.0.0 |
| **Status** | **ADAPTER LOCKED · PROVIDER DEFERRED** |
| **Owner** | Founder (RAVEN) |
| **Date** | 2026-07-21 |
...
## Port: `RealtimeChannelPort`

| Method | Contract |
|--------|----------|
| subscribe | AuthZ token bound |
| publish | Participant only |
| presence | Spectator-safe metadata |

Provider implementation swap without client API change.

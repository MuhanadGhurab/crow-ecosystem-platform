...
> **FTGP.1C correction:** Client-owner policy decoupled from retained C3 proof requester. See [FTGP_1C_REQUEST_OWNERSHIP_PROVENANCE.md](./FTGP_1C_REQUEST_OWNERSHIP_PROVENANCE.md). `ELIGIBLE_FIRST_REQUEST_COUNT=1` when owner is authoritative and eligible (`FTGP-REQUEST-CANDIDATE-07`).
...
| FTGP-REQUEST-CANDIDATE-07 | `9439dd8cc806696e` | `PENDING_REVIEW` | eligible (authoritative client owner) |

...
|----|-----------|------------------|-------|---|--------|
| **C2.1** | Preview migration readiness gate (no paid infra) | Read-only Preview DB audit, isolation fingerprint, migration history, backfill dry-run, apply runbook, `c2-preview-readiness:verify` | Muhanad | **100%** | **Blocked** — **BLOCKED — PREVIEW/PRODUCTION DATABASE ISOLATION NOT PROVEN** — branch `feat/c2-1-preview-migration-readiness` stacked on C2 — no hosted apply in C2.1 — [`C2_1_PREVIEW_MIGRATION_READINESS_GATE.md`](C2_1_PREVIEW_MIGRATION_READINESS_GATE.md) |

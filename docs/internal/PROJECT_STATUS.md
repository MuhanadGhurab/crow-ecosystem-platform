...
**Last updated:** 6 Jun 2026 (M4C.1 tenant invite acceptance release smoke — **CONDITIONAL PASS**; M4C implementation — **PASSED** on branch `cffaf95`; M4B tenant invite/onboarding — **PASSED**; M3.5 purchase-to-stock manual smoke — **CONDITIONAL PASS**; M4 tenant membership — **PASSED**; production deploy **Ready** on `main` without M4C merge)  

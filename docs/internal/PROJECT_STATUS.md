...
**Last updated:** 27 May 2026 (I6 Scope Approval + ProCrow Status Sync)  
...
**Roadmap:** **Paused** at v0.30 portfolio baseline. **H1**, **I1**, **I2**, **I3**, **I4**, **I5**, and **I6** complete on the client-portal track. **I6** delivered authenticated scope approval (strong ownership), blueprint status + platform notification, client/admin status sync, and `client-approval:verify`. Next: **I7 — Onboarding Tracker MVP**. **No paid infra** in the default path.

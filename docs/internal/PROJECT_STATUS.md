...
**Last updated:** 27 May 2026 (I3 Client Portal data contract & route skeleton)  
...
**Roadmap:** **Paused** at v0.30 portfolio baseline. **H1**, **I1**, **I2**, and **I3** complete on the client-portal track. **I3** delivered typed contract, `/client/*` skeleton, token safety on `/proposal/[token]`, and `client-portal:verify`. Next: **I4 — Client Profile + Company Profile MVP**. **No paid infra** in the default path.

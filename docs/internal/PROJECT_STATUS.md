...
**Last updated:** 5 Jun 2026 (M3.5 purchase-to-stock manual smoke — **CONDITIONAL PASS**; M4 tenant membership — **PASSED**; M3.4 workflow persistence — **PASSED**; production deploy **Ready** on `531a9e0`)  

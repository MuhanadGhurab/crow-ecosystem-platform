...
**Roadmap:** **Paused** at v0.30 portfolio baseline. **H1**, **I1**–**I11** complete on the client-portal track. **J1** unified ProCrow UX; **J2** deepened the control tower dashboard (operator queue, flow strip, posture summaries). **Resume primary:** **J3 — ProCrow Request-to-Tenant Operator Queue**. **No paid infra** in the default path.

...
**Last updated:** 5 Jun 2026 (M4B tenant invite/onboarding — **PASSED**; M3.5 purchase-to-stock manual smoke — **CONDITIONAL PASS**; M4 tenant membership — **PASSED**; production deploy **Ready** on `531a9e0`)  

...
**Last updated:** 27 May 2026 (I11 Client Portal Checkpoint & Pause)  
...
**Roadmap:** **Paused** at v0.30 portfolio baseline. **H1**, **I1**–**I11** complete on the client-portal track. **I11** closed the I-series with arc audit, capability/security checkpoint, route map, verifier index, manual smoke checklist, and [`CLIENT_PORTAL_RUNBOOK.md`](CLIENT_PORTAL_RUNBOOK.md). **Resume primary:** **J1 — ProCrow Portal UX Unification**. **No paid infra** in the default path.

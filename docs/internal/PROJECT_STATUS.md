...
**Last updated:** 5 Jun 2026 (M4 tenant membership & Business Portal access — **PASSED** PATH A; M3.4 workflow persistence — **PASSED**; P0 production **Ready** on `847d492`)  

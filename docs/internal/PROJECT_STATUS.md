...
**Roadmap:** **Paused** at v0.30 portfolio baseline. **H1**, **I1**–**I10** complete on the client-portal track. **I9** added organization membership + `canApproveScope`; **I10** added client review notes + gated request-changes via platform notifications (no new schema). **No paid infra** in the default path.

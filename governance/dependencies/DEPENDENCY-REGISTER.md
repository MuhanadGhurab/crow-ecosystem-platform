...
| DEP-122 | Controlled Core Crow Lineage derivation planning (not all-25 batch) | Governance/Design | **Partially satisfied (Operate 5/25 via 1F)** | Requires Founder-named next Gate for remaining Horizons · Horizon-by-Horizon | Founder | Unreviewed remaining-20 batch | Future Lineage Gate |
...
| DEP-125 | Controlled Build (and later Horizon) Lineage derivation after founder decision | Governance/Design | Eligible for planning · not started | Requires Founder-named next Gate · not all-20 batch | Founder | Unreviewed multi-Horizon generation | Future Lineage Gate |

...
GHV-IMP-AUTH-002 GRANTED — LIMITED TO GHV.IMPLEMENTATION.0B ACTIVATION SLICE
GHV-IMP-AUTH-003 GRANTED — LIMITED TO GHV.IMPLEMENTATION.0C ACTIVATION UX HARDENING
GHV-IMP-AUTH-004 GRANTED — LIMITED TO GHV.IMPLEMENTATION.0D PERSONALIZATION AND ORIGIN SLICE
GHV.IMPLEMENTATION.0A: PASS — LIMITED PRODUCT CODE AUTHORIZED AND FOUNDATION BOOTSTRAPPED WITH CI VERIFIED
Remote CI: VERIFIED
Closure: PARTIAL — NON-BLOCKING DEPENDENCY CONDITIONS RETAINED
...
ADV-003 FIXED · ADV-001/ADV-002 retained Moderate
GHV.IMPLEMENTATION.0C: PARTIAL — ACTIVATION UX, ACCESSIBILITY AND ONBOARDING ENTRY HARDENING COMPLETE WITH NON-BLOCKING VALIDATION CONDITIONS
...
Activation UX Baseline: ACTIVE WITH CONDITIONS v0.3.0
...
Personalization/Origin Baseline: ACTIVE WITH CONDITIONS v0.4.0
...
Crow Identity Intake Baseline: ADMITTED CANDIDATE v0.1.1 · NO IMPLEMENTATION AUTHORITY
...
GHURAVIA Crow Identity Lifecycle Baseline: LOCKED v1.0.0 · NO RUNTIME IMPLEMENTATION AUTHORITY
...
GHURAVIA Crow Visual and Motion Identity Baseline: LOCKED v1.0.0 · NO RUNTIME IMPLEMENTATION AUTHORITY
...
Selected Mother Forms: Operate MF-O-B · Build MF-B-A v0.2 · Analyze MF-A-A · Protect MF-P-A · Lead MF-L-B
Selected Operate Lineages: CRW-OPR-01 A · CRW-OPR-02 C · CRW-OPR-03 C · CRW-OPR-04 A · CRW-OPR-05 B (1F)
Selected Build Lineages: CRW-BLD-01 · CRW-BLD-02 · CRW-BLD-03 · CRW-BLD-04 · CRW-BLD-05 (1G external dossier visuals)
Core Crow Lineages selected: 10 / 25 · Remaining: 15 / 25
GHV.CROW-IDENTITY.1F: PASS — FIVE OPERATE CORE CROW LINEAGE VISUAL DIRECTIONS FOUNDER SELECTED UNDER LOCKED MF-O-B WITH HASHED LOCAL EVIDENCE, CONTROLLED FAMILY-COLLISION RISK, NO PRODUCTION APPROVAL AND NO RUNTIME AUTHORITY
Selected Operate Lineages: CRW-OPR-01 A · CRW-OPR-02 C · CRW-OPR-03 C · CRW-OPR-04 A · CRW-OPR-05 B
GHV.CROW-IDENTITY.1G: PASS — FIVE BUILD CORE CROW LINEAGE VISUAL DIRECTIONS AND THE GHURAVIA BUILD DOSSIER FAMILY SYSTEM FOUNDER APPROVED UNDER LOCKED MF-B-A v0.2 WITH HASHED LOCAL EVIDENCE, ACCEPTED FAMILY COHESION RISK, OPEN COPY AND PRODUCTION-DERIVATIVE DEBT, NO PRODUCTION APPROVAL AND NO RUNTIME AUTHORITY
Selected Build Lineages: CRW-BLD-01 · CRW-BLD-02 · CRW-BLD-03 · CRW-BLD-04 · CRW-BLD-05
...
Next Gate: REQUIRES FOUNDER DECISION · DO NOT INVENT
...
GHV-IMP-AUTH-006 GRANTED — LIMITED TO GHV.IMPLEMENTATION.0F LIVING MISSION / CROWPRINT KERNEL BLACK SIGNAL SLICE
GHV.IMPLEMENTATION.0F: PARTIAL — LIVING MISSION AND CROWPRINT KERNEL — FIRST FLIGHT BLACK SIGNAL COMPLETE WITH NON-BLOCKING CONDITIONS · Remote CI SUCCESS · SHA 413a1e9 · Run 30163111257
Product Kernel: GHURAVIA LIVING MISSION AND CROWPRINT PRODUCT KERNEL — FOUNDER APPROVED AND LOCKED
Black Signal: ALPHA FIXTURE · NOT EXPERT APPROVED · NOT PILOT VALIDATED · NOT PUBLICATION READY · NOT CERTIFICATION CONTENT
Suggested Lineage runtime: PRIVATE ALPHA ONLY (Operate+Build eligible) · NO Earned · NO Mark · NO public projection
...
GHV.IMPLEMENTATION.0G: READY FOR FOUNDER ACCEPTANCE — CONTROLLED PREVIEW ESTABLISHED · DEP-134 SATISFIED · HOSTED SMOKE PASS · PRODUCTION NOT AUTHORIZED · FOUNDER VERDICT PENDING
Preview: CONTROLLED · PROTECTED · SYNTHETIC demo_only · Core Platform only · SHA c61505a · dpl_LQFRGwjRSMmTAfSTtrsfZ6NoAd1h
...
GATE VERDICTS: … · CROW-IDENTITY.1A PARTIAL — AMENDED · CROW-IDENTITY.1A-AMENDMENT-01 PASS · CROW-IDENTITY.1B PASS · CROW-IDENTITY.1C PASS · CROW-IDENTITY.1D PASS · CROW-IDENTITY.1E PASS · CROW-IDENTITY.1F PASS · CROW-IDENTITY.1G PASS · 0E PARTIAL · 0F PARTIAL
...
2. Scope Baseline
3. Baseline Manifest
4. Master User Journey
5. Screen and State Architecture
6. Capability Registry
7. Decision Register
8. Supporting domain baselines
9. Templates and research documents
```
...
|------------|-------------------|-------|
| Product Code authorization | [GHV.IMPLEMENTATION.0A.md](../gates/GHV.IMPLEMENTATION.0A.md) · [GHV.IMPLEMENTATION.0A-CLOSURE-01.md](../gates/GHV.IMPLEMENTATION.0A-CLOSURE-01.md) · [GHV.IMPLEMENTATION.0A-CLOSURE-01-AMENDMENT-01.md](../gates/GHV.IMPLEMENTATION.0A-CLOSURE-01-AMENDMENT-01.md) · [GHV.IMPLEMENTATION.0B.md](../gates/GHV.IMPLEMENTATION.0B.md) · [GHV.IMPLEMENTATION.0B-CLOSURE-01.md](../gates/GHV.IMPLEMENTATION.0B-CLOSURE-01.md) · [GHV.IMPLEMENTATION.0C.md](../gates/GHV.IMPLEMENTATION.0C.md) · [GHV.IMPLEMENTATION.0C-CLOSURE-01.md](../gates/GHV.IMPLEMENTATION.0C-CLOSURE-01.md) · [GHV.IMPLEMENTATION.0C-CLOSURE-02.md](../gates/GHV.IMPLEMENTATION.0C-CLOSURE-02.md) · [GHV.IMPLEMENTATION.0D.md](../gates/GHV.IMPLEMENTATION.0D.md) · [GHV.IMPLEMENTATION.0D-CLOSURE-01.md](../gates/GHV.IMPLEMENTATION.0D-CLOSURE-01.md) · [GHV.IMPLEMENTATION.0D-CLOSURE-01-AMENDMENT-01.md](../gates/GHV.IMPLEMENTATION.0D-CLOSURE-01-AMENDMENT-01.md) · [GHV.CROW-IDENTITY.1A.md](../gates/GHV.CROW-IDENTITY.1A.md) · [GHV.CROW-IDENTITY.1A-AMENDMENT-01.md](../gates/GHV.CROW-IDENTITY.1A-AMENDMENT-01.md) · [GHV.CROW-IDENTITY.1B.md](../gates/GHV.CROW-IDENTITY.1B.md) · [GHV.CROW-IDENTITY.1C.md](../gates/GHV.CROW-IDENTITY.1C.md) · [GHV.CROW-IDENTITY.1D.md](../gates/GHV.CROW-IDENTITY.1D.md) · [GHV.CROW-IDENTITY.1E.md](../gates/GHV.CROW-IDENTITY.1E.md) · [GHV.CROW-IDENTITY.1F.md](../gates/GHV.CROW-IDENTITY.1F.md) · [GHV.CROW-IDENTITY.1G.md](../gates/GHV.CROW-IDENTITY.1G.md) | **0A–0D as prior** · **CROW-IDENTITY.1A PARTIAL — AMENDED** · **1A-AMENDMENT-01 PASS** · **1B–1G PASS** · **no Crow Identity runtime** |
...
| Crow Identity Lifecycle Baseline v1.0.0 | [GHURAVIA-CROW-IDENTITY-LIFECYCLE-BASELINE.md](../../product/identity/crow-system/governance/GHURAVIA-CROW-IDENTITY-LIFECYCLE-BASELINE.md) | **LOCKED** Chosen/Suggested/Earned design · Evidence-before-Mastery · privacy/projection · NO runtime authority |
| Crow Visual and Motion Identity Baseline v1.0.0 | [GHURAVIA-CROW-VISUAL-AND-MOTION-BASELINE.md](../../product/identity/crow-system/visual/governance/GHURAVIA-CROW-VISUAL-AND-MOTION-BASELINE.md) | **LOCKED** visual/symbol/motion design · REFERENCE LOCKED plates · NO runtime authority |
| Selected Mother Form directions (1E) | [SELECTED-MOTHER-FORM-MANIFEST.md](../../product/identity/crow-system/visual/comparison/1E/founder-review/SELECTED-MOTHER-FORM-MANIFEST.md) · [GHV.CROW-IDENTITY.1E.md](../gates/GHV.CROW-IDENTITY.1E.md) | **FOUNDER SELECTED** · LOCAL hashes · NOT production · NO runtime |
| Selected Operate Lineage directions (1F) | [SELECTED-OPERATE-LINEAGE-MANIFEST.md](../../product/identity/crow-system/visual/development/1F/founder-review/SELECTED-OPERATE-LINEAGE-MANIFEST.md) · [GHV.CROW-IDENTITY.1F.md](../gates/GHV.CROW-IDENTITY.1F.md) | **FOUNDER SELECTED** O1 A · O2 C · O3 C · O4 A · O5 B · LOCAL hashes · NO runtime |
| Selected Build Lineage visual directions (1G) | [SELECTED-BUILD-LINEAGE-VISUAL-MANIFEST.md](../../product/identity/crow-system/visual/development/1G/founder-review/SELECTED-BUILD-LINEAGE-VISUAL-MANIFEST.md) · [GHV.CROW-IDENTITY.1G.md](../gates/GHV.CROW-IDENTITY.1G.md) | **FOUNDER APPROVED** B1–B5 external dossiers · LOCAL hashes · Core 10/25 · NO runtime |
...
| Definition | Authoritative file | Notes |
|------------|-------------------|-------|
| Product definition sentence | [PRODUCT-CONSTITUTION.md](../constitution/PRODUCT-CONSTITUTION.md) | Summaries must link |
| Product Pillars | Constitution | — |
| Product Principles / Integrity Rules / Non-Goals | Constitution | — |
| Audience / 15+ / minors condition | Constitution | Scope may reference |
| Regional architecture principle | Constitution | — |
| Scope classification vocabulary | [SCOPE-BASELINE.md](../scope/SCOPE-BASELINE.md) | — |
| Minimum Lovable Governed World (20 outcomes) | Scope Baseline | — |
| Nest thresholds | Scope Baseline | — |
| Horizons list | Scope Baseline (+ Constitution summary) | Names must match |
| Access Plan prices & concurrent Routes | Scope Baseline §3.19 | Commercial Baseline summarizes |
| Merit Access direction | Scope Baseline | Criteria pending PROGRESSION/LEARNING |
| Prestige Class names | Scope Baseline (+ Constitution integrity) | Ascendant / Apex / Obsidian Raven |
| Launch deadline 2029-12-31 | Constitution + Scope | Same date |
| First-launch exclusions | Scope Baseline | — |
...
| Learning research method | [LEARNING-RESEARCH-METHODOLOGY.md](../../product/learning/research/LEARNING-RESEARCH-METHODOLOGY.md) | Research inputs; portfolio authority = Manifest |
| **Learning portfolio (design baseline)** | [LEARNING-PORTFOLIO-MANIFEST.md](../../product/learning/governance/LEARNING-PORTFOLIO-MANIFEST.md) | **Authoritative** — v1.0.0 LOCKED AS DESIGN BASELINE |
| Design status vocabulary | [LEARNING-DESIGN-STATUS-MODEL.md](../../product/learning/governance/LEARNING-DESIGN-STATUS-MODEL.md) | Separates design lock from publication |
| Registry reconciliation | [LEARNING-REGISTRY-RECONCILIATION.md](../../product/learning/governance/LEARNING-REGISTRY-RECONCILIATION.md) | Exact totals |
| Design freeze | [LEARNING-DESIGN-FREEZE-POLICY.md](../../product/learning/governance/LEARNING-DESIGN-FREEZE-POLICY.md) | Change control after 1D |
| Publication readiness | [PUBLICATION-READINESS-MATRIX.md](../../product/learning/governance/PUBLICATION-READINESS-MATRIX.md) | Publication BLOCKED until reviews |
| Known limitations | [LEARNING-KNOWN-LIMITATIONS.md](../../product/learning/governance/LEARNING-KNOWN-LIMITATIONS.md) | Visible after lock |
| Learning handoff | [LEARNING-HANDOFF-PACKAGE.md](../../product/learning/governance/LEARNING-HANDOFF-PACKAGE.md) | → PROGRESSION.1 / ARCHITECTURE.1 |
| Launch Route portfolio | [LAUNCH-ROUTE-PORTFOLIO-RECOMMENDATION.md](../../product/learning/routes/LAUNCH-ROUTE-PORTFOLIO-RECOMMENDATION.md) | Supporting; IDs locked via Manifest |
| Route architecture | `product/learning/routes/architecture/` | Supporting design |
| Graph standards | [LAUNCH-GRAPH-REGISTRY.md](../../product/learning/graph/LAUNCH-GRAPH-REGISTRY.md) · [GRAPH-INVARIANTS.md](../../product/learning/graph/GRAPH-INVARIANTS.md) | Conceptual only |
| Mission Blueprints | [MISSION-BLUEPRINT-REGISTRY.md](../../product/learning/missions/MISSION-BLUEPRINT-REGISTRY.md) | 87 |
| Assessments | [ASSESSMENT-ANCHOR-REGISTRY.md](../../product/learning/assessments/ASSESSMENT-ANCHOR-REGISTRY.md) | 33; numeric → PROGRESSION.1 |
| Evidence | [EVIDENCE-ANCHOR-REGISTRY.md](../../product/learning/evidence/EVIDENCE-ANCHOR-REGISTRY.md) | 24 anchors |
| Rubrics | [EVIDENCE-RUBRIC-REGISTRY.md](../../product/learning/evidence/EVIDENCE-RUBRIC-REGISTRY.md) | 7 packs |
| AI assistance | [AI-ASSISTANCE-POLICY.md](../../product/learning/integrity/AI-ASSISTANCE-POLICY.md) | — |
| Integrity | [LEARNING-INTEGRITY-MODEL.md](../../product/learning/integrity/LEARNING-INTEGRITY-MODEL.md) | — |
| Capstones | [CAPSTONE-BLUEPRINT-REGISTRY.md](../../product/learning/capstones/CAPSTONE-BLUEPRINT-REGISTRY.md) | 7 |
| Route-Proven | [ROUTE-PROVEN-STANDARD.md](../../product/learning/proven/ROUTE-PROVEN-STANDARD.md) | Qualitative |
| Horizon-Proven | [HORIZON-PROVEN-STANDARD.md](../../product/learning/proven/HORIZON-PROVEN-STANDARD.md) | Awarding deferred |

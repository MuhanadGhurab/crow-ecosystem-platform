...
PASS — FOUNDER VISUAL DIRECTIONS SELECTED
GHV.CROW-IDENTITY.1F:
PASS — FIVE OPERATE CORE CROW LINEAGE VISUAL DIRECTIONS
FOUNDER SELECTED UNDER LOCKED MF-O-B
Operate Lineages: 5 / 5 SELECTED
GHV.CROW-IDENTITY.1G:
PASS — FIVE BUILD CORE CROW LINEAGE VISUAL DIRECTIONS
AND GHURAVIA BUILD DOSSIER FAMILY SYSTEM FOUNDER APPROVED
Build Lineages: 5 / 5 SELECTED · Core: 10 / 25 · Remaining: 15 / 25
...
PARTIAL — LIVING MISSION AND CROWPRINT
KERNEL — FIRST FLIGHT BLACK SIGNAL COMPLETE
WITH NON-BLOCKING CONDITIONS · Remote CI SUCCESS
SHA 413a1e9 · Run 30163111257
...
| **GHURAVIA Crow Identity System Intake Baseline v0.1.1** | **ADMITTED CANDIDATE** · **NOT ACTIVE PRODUCT TAXONOMY** · **NO IMPLEMENTATION AUTHORITY** · Source Gate **GHV.CROW-IDENTITY.1A** (**PARTIAL — AMENDED**) · **GHV.CROW-IDENTITY.1A-AMENDMENT-01** (**PASS**) · [Intake](../../product/identity/crow-system/governance/CROW-IDENTITY-1A-INTAKE-BASELINE.md) |
| **GHURAVIA Core Crow Lineage Taxonomy Baseline v1.0.0** | **LOCKED AS INTERNAL TAXONOMY DESIGN BASELINE WITH CONTROLLED PROVISIONAL ARABIC DISPLAY LABELS** · **NO RUNTIME IMPLEMENTATION AUTHORITY** · Source Gate **GHV.CROW-IDENTITY.1B** (**PASS**) · [Baseline](../../product/identity/crow-system/governance/GHURAVIA-CORE-CROW-LINEAGE-TAXONOMY-BASELINE.md) |
| **GHURAVIA Crow Identity Lifecycle Baseline v1.0.0** | **LOCKED AS INTERNAL CHOSEN, SUGGESTED AND EARNED CROW LINEAGE LIFECYCLE, EVIDENCE, MASTERY, PRIVACY AND PUBLIC-PROJECTION DESIGN BASELINE** · **NO RUNTIME IMPLEMENTATION AUTHORITY** · Source Gate **GHV.CROW-IDENTITY.1C** (**PASS**) · [Baseline](../../product/identity/crow-system/governance/GHURAVIA-CROW-IDENTITY-LIFECYCLE-BASELINE.md) |
| **GHURAVIA Crow Visual and Motion Identity Baseline v1.0.0** | **LOCKED AS INTERNAL VISUAL, SYMBOL, MOTHER-FORM, LINEAGE-MARK, MOTION, ACCESSIBILITY AND COMPOSITION DESIGN BASELINE WITH CONTROLLED REFERENCE ASSETS AND OPEN PRODUCTION-VALIDATION CONDITIONS** · **NO RUNTIME IMPLEMENTATION AUTHORITY** · Source Gate **GHV.CROW-IDENTITY.1D** (**PASS**) · [Baseline](../../product/identity/crow-system/visual/governance/GHURAVIA-CROW-VISUAL-AND-MOTION-BASELINE.md) |
| **GHURAVIA Founder-Selected Horizon Mother Form Directions (1E)** | **LOCKED AS FOUNDER-SELECTED VISUAL DIRECTIONS** · Operate **MF-O-B** · Build **MF-B-A v0.2** · Analyze **MF-A-A (Lens Wing v2)** · Protect **MF-P-A** · Lead **MF-L-B** · binaries **LOCAL CONTROLLED EVIDENCE / NOT PRODUCTION APPROVED / NOT REPOSITORY-PROMOTED** · Source Gate **GHV.CROW-IDENTITY.1E** (**PASS**) · [Manifest](../../product/identity/crow-system/visual/comparison/1E/founder-review/SELECTED-MOTHER-FORM-MANIFEST.md) |
| **GHURAVIA Founder-Selected Operate Core Crow Lineage Directions (1F)** | **LOCKED AS FOUNDER-SELECTED OPERATE LINEAGE VISUAL DIRECTIONS** · CRW-OPR-01 **A** · CRW-OPR-02 **C** · CRW-OPR-03 **C** · CRW-OPR-04 **A** · CRW-OPR-05 **B** · parent **MF-O-B** · family collision **PASS_WITH_MINOR_RISK** · binaries **LOCAL CONTROLLED EVIDENCE / NOT PRODUCTION APPROVED / NOT REPOSITORY-PROMOTED** · Source Gate **GHV.CROW-IDENTITY.1F** (**PASS**) · [Manifest](../../product/identity/crow-system/visual/development/1F/founder-review/SELECTED-OPERATE-LINEAGE-MANIFEST.md) |
| **GHURAVIA Founder-Approved Build Core Crow Lineage Visual Directions (1G)** | **LOCKED AS FOUNDER-APPROVED BUILD LINEAGE VISUAL DIRECTIONS** · CRW-BLD-01..05 external dossier visuals under **MF-B-A v0.2** · dossier family system · family collision **PASS_WITH_ACCEPTED_COHESION_RISK** · embedded copy **NON-AUTHORITATIVE** · binaries **LOCAL CONTROLLED EVIDENCE / NOT PRODUCTION APPROVED / NOT REPOSITORY-PROMOTED** · Core Lineages **10/25** · Source Gate **GHV.CROW-IDENTITY.1G** (**PASS**) · [Manifest](../../product/identity/crow-system/visual/development/1G/founder-review/SELECTED-BUILD-LINEAGE-VISUAL-MANIFEST.md) |
| GHV.CROW-IDENTITY.1A | **PARTIAL** — REPOSITORY-AWARE IMPACT MAPPING COMPLETE; PRIMARY SOURCE CORPUS WAS NOT MATERIALIZED (submitted PASS corrected by Amendment-01) |
...
| GHV.CROW-IDENTITY.1C | **PASS** |
| GHV.CROW-IDENTITY.1D | **PASS** — VISUAL / MOTION BASELINE v1.0.0 LOCKED WITH CONTROLLED REFERENCE ASSETS |
| GHV.CROW-IDENTITY.1E | **PASS** — FOUNDER VISUAL DIRECTIONS SELECTED (MF-O-B / MF-B-A v0.2 / MF-A-A / MF-P-A / MF-L-B) · LOCAL BINARY EVIDENCE · NO RUNTIME |
| GHV.CROW-IDENTITY.1F | **PASS** — FIVE OPERATE LINEAGE DIRECTIONS SELECTED (A/C/C/A/B) UNDER MF-O-B · LOCAL BINARY EVIDENCE · NO RUNTIME |
| GHV.CROW-IDENTITY.1G | **PASS** — FIVE BUILD LINEAGE VISUAL DIRECTIONS + DOSSIER FAMILY SYSTEM UNDER MF-B-A v0.2 · LOCAL BINARY EVIDENCE · NO RUNTIME |
| GHV.IMPLEMENTATION.0E | **PARTIAL — NEST INTRO AND READINESS DECISION VERTICAL SLICE COMPLETE WITH NON-BLOCKING IMPLEMENTATION CONDITIONS** · Baseline v0.5.0 |
...
| Nest Intro / Readiness Decision Baseline | **ACTIVE WITH CONDITIONS v0.5.0** — [GHURAVIA-NEST-READINESS-BASELINE.md](../implementation/GHURAVIA-NEST-READINESS-BASELINE.md) |

...
Operate Lineages: 5 / 5 SELECTED · Core: 5 / 25 · Remaining: 20 / 25
...
| **GHURAVIA Founder-Selected Operate Core Crow Lineage Directions (1F)** | **LOCKED AS FOUNDER-SELECTED OPERATE LINEAGE VISUAL DIRECTIONS** · CRW-OPR-01 **A** · CRW-OPR-02 **C** · CRW-OPR-03 **C** · CRW-OPR-04 **A** · CRW-OPR-05 **B** · parent **MF-O-B** · family collision **PASS_WITH_MINOR_RISK** · binaries **LOCAL CONTROLLED EVIDENCE / NOT PRODUCTION APPROVED / NOT REPOSITORY-PROMOTED** · Core Lineages **5/25** · Source Gate **GHV.CROW-IDENTITY.1F** (**PASS**) · [Manifest](../../product/identity/crow-system/visual/development/1F/founder-review/SELECTED-OPERATE-LINEAGE-MANIFEST.md) |

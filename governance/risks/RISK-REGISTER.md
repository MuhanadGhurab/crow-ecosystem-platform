...
| RISK-IMP-002 | Origin private context is mistaken for Trust, readiness, or Progression input | M | H | H | Adaptation or Nest readiness uses Origin as scoring signal | Preserve Origin ≠ Trust/Readiness invariants; no adaptation execution in 0D | Block readiness scoring until authorized Gate | Founder | Open | Before 0E Nest readiness | CAP-ONB-* |

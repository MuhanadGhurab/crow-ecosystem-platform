...
| RISK-IMP-002 | Origin private context is mistaken for Trust, readiness, or Progression input | M | H | H | Adaptation or Nest readiness uses Origin as scoring signal | Preserve Origin ≠ Trust/Readiness invariants; Nest scoring excludes Origin | Keep Origin out of readiness score paths | Founder | **Mitigated (0E)** · residual Open for later adaptation | 0E acceptance | CAP-ONB-* |
| RISK-IMP-003 | Native loopback PostgreSQL is mistaken for external/cloud database proof | M | M | M | Agent VM DB path presented as Preview isolation | Local DB execution record · disposable cleanup evidence | Keep Preview blocked | Founder | Open | Before Preview | CAP-TRU-014 |
| RISK-CRW-001 | Identity taxonomy collision across Horizons/Routes | H | H | H | Overlapping capability centers | 1B collision tests · protected centers | Hold taxonomy freeze | Founder | Open | CROW-IDENTITY.1B | CAP-ONB-* |
| RISK-CRW-002 | Visual identity interpreted as skill | H | H | H | Art mistaken for Mastery | Non-color cues · structured facts · copy rules | Block earned-looking placeholders | Founder | Open | CROW-IDENTITY.1D | CAP-EBUX-* |
| RISK-CRW-003 | Self-selected identity presented as earned | H | H | H | Chosen Crow shown as proof | Chosen≠earned states · UI bans | Prohibit self-award marks | Founder | Open | CROW-IDENTITY.1C | CAP-ONB-* |
| RISK-CRW-004 | Payment-to-proof leakage into identity | H | H | H | Entitlement events write identity | One-way entitlement→access tests | Block identity writes from payment | Founder | Open | Pre-monetization | CAP-PAY-* |
| RISK-CRW-005 | Trust inference leakage via Crow visuals | H | H | H | Flock/ornament implies Trust | Trust exclusion · Canon conflict closed | Ban Trust renderer inputs | Founder | Mitigated (1A boundary) | Continuous | CAP-TRU-* |
| RISK-CRW-006 | Lineage Mark / Evidence Seal collision | H | H | H | Glyph impersonates Evidence | Symbol namespaces · seal auth | Reject decorative seals | Founder | Open | CROW-IDENTITY.1C/1D | CAP-LRN-* |
| RISK-CRW-007 | Major / Lineage conflation | H | H | H | Two-Horizon completion = Major | Qualification grammar · no auto award | Hold Major awards | Founder | Open | CROW-IDENTITY.1C | CAP-LRN-* |
| RISK-CRW-008 | 50 provisional Majors treated as curricula | M | H | H | Working names shipped as courses | Provisional labeling · curriculum Gates | Do not publish as awards | Founder | Open | Later Learning Gates | CAP-LRN-* |
| RISK-CRW-009 | Crow identity becoming a career prison | H | H | H | Permanent Horizon lock | Nest≠Lineage · transfer rules | Allow cross-Horizon growth | Founder | Open | Pre-0E / 1B | CAP-ONB-* |
| RISK-CRW-010 | Cultural stereotype risk in names/motifs | M | H | H | Hunter/Warden/Commander tropes | Arabic/cultural review in 1B/1D | Rename or soften | Founder | Open | CROW-IDENTITY.1B/1D | CAP-EBUX-* |
| RISK-CRW-011 | Arabic terminology risk | H | M | H | Unreviewed Arabic labels | Linguistic review plan | Provisional internal English only | Founder | Open | CROW-IDENTITY.1B | CAP-GOV-* |
| RISK-CRW-012 | Accessibility / color-only identity risk | H | H | H | Color-only differentiation | Independent cues · reduced motion | Fail visual Gate | Founder | Open | CROW-IDENTITY.1D | CAP-EBUX-* |
| RISK-CRW-013 | Animation overload / reduced-motion failure | M | H | H | Motion-only meaning | Priority stack · reduced-motion parity | Disable unsafe motion | Founder | Open | CROW-IDENTITY.1D | CAP-EBUX-* |
| RISK-CRW-014 | Deterministic renderer / version drift | H | H | H | Non-reproducible Crow | Versioned state + assets | Block runtime generative identity | Founder | Open | CROW-IDENTITY.1C/1D | CAP-TRU-* |
| RISK-CRW-015 | Public-profile privacy leakage | H | H | H | Private Evidence/Trust indexed | Projection contract · search allowlist | Default private | Founder | Open | CROW-IDENTITY.1C | CAP-TRU-* |
...
| RISK-CRW-019 | 0E readiness accidentally awarding identity | H | H | H | Nest score → Lineage | Nest vocabulary contract · zero-impact helpers · acceptance bans | Keep earned-identity writes blocked | Founder | **Mitigated (0E local)** · residual Open until remote CI | During/after 0E | CAP-ONB-* |
...
| RISK-CRW-023 | Nest readiness misread as Core Crow Lineage / identity award | H | H | H | Nest Result language or score presented as Lineage | Nest Vocabulary Contract · disclaimer copy · tests | Keep non-award copy in UI | Founder | **Mitigated (0E copy)** · residual Monitored | During 0E | CAP-ONB-* |

| RISK-CRW-024 | Chosen treated as earned proof | H | H | H | UI conflation | Chosen contract + projection labels | Product review | Founder | **OPEN** | Mitigated by 1C design | CROW-IDENTITY.1C |
...
| RISK-CRW-032 | Treating 1E Mother Form direction selection as PRODUCTION APPROVED character art | H | H | H | Premature production claim | Direction lock ≠ production art · LOCAL_ONLY_NO_COMMIT | Founder art review | Founder | **OPEN** | Mitigated by 1E non-claims | CROW-IDENTITY.1E |
| RISK-CRW-033 | Reintroducing Build tool/accessory identity after MF-B-A v0.2 | H | H | H | Accessory-dependent Build regression | Empty-talon / no-tool hard gate · v0.1 rejected evidence retained | Product review | Founder | **OPEN** | Mitigated by 1E correction | CROW-IDENTITY.1E |
| RISK-CRW-034 | Generating all 25 Lineages in one unreviewed batch after 1E | H | H | H | Unreviewed identity explosion | Horizon-by-Horizon planning only · founder Gate required | Founder decision | Founder | **OPEN** | Explicit prohibition | CROW-IDENTITY.1E |
| RISK-CRW-035 | Treating 1F Operate Lineage direction selection as PRODUCTION APPROVED character art | H | H | H | Premature production claim | Direction lock ≠ production art · LOCAL_ONLY_NO_COMMIT | Founder art review | Founder | **OPEN** | Mitigated by 1F non-claims | CROW-IDENTITY.1F |
| RISK-CRW-036 | O1/O4 internal silhouette collision after founder selection | M | M | M | Family confusion at small size | Controlled polish notes · directions unchanged | Product review | Founder | **OPEN** | PASS_WITH_MINOR_RISK accepted | CROW-IDENTITY.1F |
| RISK-CRW-037 | Generating remaining 20 Lineages in one unreviewed batch after 1F | H | H | H | Unreviewed identity explosion | Horizon-by-Horizon · founder-named next Gate only | Founder decision | Founder | **SUPERSEDED** | Remaining count updated by 1G to 15; see RISK-CRW-041 | CROW-IDENTITY.1F |
| RISK-CRW-038 | Build B1/B3/B5 remain visually close at family level | M | M | M | Family confusion at production scale | Founder accepted directional cohesion risk · production-art differentiation remains open | Product review | Founder | **OPEN** | PASS_WITH_ACCEPTED_COHESION_RISK | CROW-IDENTITY.1G |
| RISK-CRW-039 | Embedded AI-generated dossier copy may contain wording drift | M | M | M | Copy contradicts locked taxonomy | Repository taxonomy remains authoritative · future copy-proofing required | Product/copy review | Founder | **OPEN** | Non-authoritative presentation text | CROW-IDENTITY.1G |
| RISK-CRW-040 | Dossier silhouette and 48 px panels are not exact production derivatives | M | H | H | False technical certification | Separate extraction and validation required before runtime | Art/tech validation | Founder | **OPEN** | Visual studies only | CROW-IDENTITY.1G |
| RISK-CRW-041 | Generating remaining 15 Lineages in one unreviewed batch after 1G | H | H | H | Unreviewed identity explosion | Horizon-by-Horizon · founder-named next Gate only · all-15 batch prohibited | Founder decision | Founder | **OPEN** | Explicit prohibition | CROW-IDENTITY.1G |
| RISK-CRW-042 | Treating 1G Build Lineage visual direction lock as PRODUCTION APPROVED character art | H | H | H | Premature production claim | Direction lock ≠ production art · LOCAL_ONLY_NO_COMMIT | Founder art review | Founder | **OPEN** | Mitigated by 1G non-claims | CROW-IDENTITY.1G |

...
| CAP-IDN-006 | Founder-approved Build Core Crow Lineage visual directions | Identity | CORE FOUNDATION (design) | Identity | — | Specified | B1–B5 external dossier visuals under MF-B-A v0.2 · dossier family system · local hashes · PASS_WITH_ACCEPTED_COHESION_RISK · non-authoritative embedded copy · not production art · no runtime | Founder | CROW-IDENTITY.1G |

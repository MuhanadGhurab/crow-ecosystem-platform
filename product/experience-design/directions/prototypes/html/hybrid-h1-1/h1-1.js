...
(function () {
  ...
  if (qs("[data-portal-boot]")) {
    window.setTimeout(function () {
      notify({
        kind: "world",
        tag: "إشارة عالم",
        text: "نشاط نموذجي في السماء الحيّة — بلا تشغيل فعلي.",
      });
  ...
  var outcomes = {
    A: {
      label: "جمع معلومات قبل التنفيذ",
      summary: "جمعت معلومات إضافية قبل التوسيع. المركز يستقر. توفر الخدمة يتحسّن. المخاطر تنخفض. الدين ينخفض. الثقة ترتفع.",
      world: [
        { k: "توفر الخدمة", v: "يتحسّن", t: "ok" },
        { k: "وضوح الأدلة", v: "أقوى", t: "ok" },
        { k: "مستوى المخاطر", v: "أقل", t: "ok" },
        { k: "الدين التقني", v: "ينخفض", t: "ok" },
        { k: "ثقة الأطراف", v: "ترتفع", t: "ok" },
      ],
      nodes: { core: "ok", edge: "ok", svc: "ok" },
      edges: { e1: "stable", e2: "stable" },
      raven: "راقبت قبل التوسيع. الوضع أكثر استقراراً الآن — راجع الخريطة والملخص.",
      signal: { kind: "mission", tag: "إشارة مهمة", text: "مسار جمع المعلومات فعّال — تحسّن توفر الخدمة." },
    },
    B: {
      label: "استعادة الخدمة أولاً",
      summary: "أعدت الخدمة بسرعة مع مراقبة لاحقة. توفر الخدمة يعود جزئياً. الأدلة متوسطة. المخاطر متوسطة. الدين يرتفع قليلاً.",
      world: [
        { k: "توفر الخدمة", v: "جزئي", t: "warn" },
        { k: "وضوح الأدلة", v: "متوسط", t: "info" },
        { k: "مستوى المخاطر", v: "متوسط", t: "warn" },
        { k: "الدين التقني", v: "يرتفع قليلاً", t: "warn" },
        { k: "ثقة الأطراف", v: "مختلطة", t: "warn" },
      ],
      nodes: { core: "ok", edge: "", svc: "ok" },
      edges: { e1: "stable", e2: "" },
      raven: "الخدمة عادت جزئياً. راقب الحافة؛ المخاطر لم تُغلَق بالكامل.",
      signal: { kind: "mission", tag: "إشارة مهمة", text: "استعادة خدمة — راقب الحافة." },
    },
    C: {
      label: "اختصار عالي المخاطر",
      summary: "اختصار سريع أعاد الاستجابة جزئياً ووسّع نطاق التعرّض للمخاطر. توفر الخدمة متقطع. الأدلة غير واضحة. المخاطر أعلى. الدين يتراكم. الثقة تتراجع.",
      world: [
        { k: "توفر الخدمة", v: "متقطع", t: "risk" },
        { k: "وضوح الأدلة", v: "غير واضحة", t: "warn" },
        { k: "مستوى المخاطر", v: "أعلى", t: "risk" },
        { k: "الدين التقني", v: "يتراكم", t: "risk" },
        { k: "ثقة الأطراف", v: "تتراجع", t: "risk" },
      ],
      nodes: { core: "hot", edge: "hot", svc: "" },
      edges: { e1: "stressed", e2: "stressed" },
      raven: "الحيّ تأثر. للاختصار ثمن ظاهر — لا أخفيه.",
      signal: { kind: "risk", tag: "تنبيه مخاطر", text: "اتسع نطاق التعرّض للمخاطر بعد الاختصار." },
    },
  };
  ...
  function applyOutcome(key) {
    ...
    if (save) {
      ...
      window.setTimeout(function () {
        ...
        notify({ kind: "save", tag: "حفظ", text: "حالتك محفوظة ومتزامنة (نموذج)." });
  ...
  if (echoBtn && echo) {
    echoBtn.addEventListener("click", function () {
      ...
      notify({ kind: "raven", tag: "ملاحظة RAVEN", text: "رحلة الصدى مفتوحة — رحلتك الأصلية محفوظة." });
      var liveE = qs("[data-live-echo]");
      if (liveE) liveE.textContent = "رحلة الصدى منفصلة؛ رحلتك الأصلية تبقى مرئية.";
    });
  }
})();

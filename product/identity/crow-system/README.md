...
| **Visual / Motion Baseline** | v1.0.0 — LOCKED (design; REFERENCE LOCKED plates) |
| **Selected Mother Form directions** | LOCKED (1E) — Operate MF-O-B · Build MF-B-A v0.2 · Analyze MF-A-A · Protect MF-P-A · Lead MF-L-B |
| **Selected Operate Lineage directions** | LOCKED (1F) — O1 A · O2 C · O3 C · O4 A · O5 B |
...
```text
intake/v0.1/              Immutable candidate corpus + integrity records
taxonomy/                 Locked Core Crow Lineage taxonomy design artifacts
lifecycle/                Locked Chosen/Suggested/Earned lifecycle design artifacts
visual/                   Locked visual/symbol/motion design + reference SVG plates
visual/comparison/1E/     Local Mother Form comparison working set (binaries not committed)
visual/development/1F/    Local Operate Lineage development working set (binaries not committed)
visual/development/1G/    Local Build Lineage development + founder-approved external evidence (binaries not committed)
governance/               Repository-aware analysis, baselines, open decisions
```

## Status discipline

Source status and repository disposition are separate fields. A source self-label (`LOCKED`, `CANONICAL`, `FINAL`) does not create repository baseline authority.

REFERENCE LOCKED visual plates and 1E/1F/1G selected local candidates are **not** PRODUCTION APPROVED and have **no** runtime authorization.

1G Build approvals use external founder-directed dossier visuals. Pre-benchmark 15 A/B/C candidates remain historical exploration only.

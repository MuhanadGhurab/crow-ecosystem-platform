  ...
  return (
    <div className="space-y-8">
      <PageHeader
        ...
        entity="cem"
        title="Reports"
        description={`Cross-module KPIs and executive snapshots for ${tenant.organization.displayName}.`}
      />
      ...
      {showLogisticsHub && (
        <ErpModuleHub
          ...
          logisticsCopy={{
            title: "ERP insights",
            description:
              "Pipeline, stock alerts, receivables, and workflow throughput aggregated from enabled CEM modules.",
            links: [
      ...
      {!hasAnyErpData && (
        <p className="text-sm text-slate-500">
          ...
          {hasReportsModule && (
            <>
              {" "}
              Try <code className="text-cyan-400">npm run db:seed:tenant:ops -- --tenant={slug}</code>
            </>
          )}
        </p>
      )}

      <ErpChainLinks tenantSlug={slug} currentModule="finance" tenantModules={tenantModules} />

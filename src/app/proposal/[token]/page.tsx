...
import { ProposalTokenClientPortalCta } from "@/components/client-portal/proposal-token-client-portal-cta";
      ...
      <div className="cc-proposal-page-inner">
        <header className="text-center sm:text-left">
          ...
          <p className="mt-2 text-xs text-slate-500">
            Public summary only — scope approval and request changes happen in the Client Portal
            after sign-in.
          </p>
        </header>

        <ProposalTokenClientPortalCta token={token} user={user} />
        ...
        {status === "SENT" && <ProposalTokenApprovalNotice />}
      </div>
    </div>
  );
}

...
export function PublicAuthFrame({
  ...
  return (
    <div
      className={`public-v2-shell ${PUBLIC_V2_BRIGHT_IDENTITY_MARKER} ${PUBLIC_V2_COLORFUL_IDENTITY_MARKER} ${PUBLIC_V2_SEMI_DARK_IDENTITY_MARKER} relative flex min-h-[100dvh] flex-col overflow-x-hidden`}

...
const seeds: FieldSeed[] = [
  ...
  // Construction
  { key: "general_contracting", name: "General contracting", nameAr: "المقاولات العامة", desc: "Building construction and civil project delivery.", category: "construction_engineering", archetype: "construction_and_epc", aliases: ["contractor", "builder", "construction company", "مقاول"], misspellings: ["contruction", "contracter"], examples: ["Commercial builder", "Residential contractor"], purposes: ["deliver_projects"], ssic: "4100", isic: "4100" },
  ...
  { key: "ecommerce_online_retail", name: "E-commerce and online retail", nameAr: "التجارة الإلكترونية", desc: "Online stores, marketplaces, and digital retail.", category: "retail_ecommerce", archetype: "retail_and_commerce", aliases: ["online shop", "ecommerce", "e-commerce", "web store", "متجر إلكتروني"], misspellings: ["ecomerce", "ecom"], examples: ["D2C brand", "Online marketplace seller"] },
  ...
  { key: "restaurant_food_service", name: "Restaurant and food service", nameAr: "المطاعم وخدمات الطعام", desc: "Restaurants, cafés, and food service operators.", category: "hospitality_food", archetype: "food_service", aliases: ["restaurant", "cafe", "café", "catering", "مطعم"], misspellings: ["resturant"], examples: ["Fine dining", "Cloud kitchen"] },
  ...
  // Legal & accounting
  { key: "legal_practice", name: "Legal practice", nameAr: "الممارسة القانونية", desc: "Law firms and legal advisory services.", category: "legal_accounting", archetype: "professional_services", aliases: ["law firm", "lawyer", "attorney", "محاماة"], regulated: "Legal practice may require matter confidentiality controls.", ssic: "6910" },
  ...
  { key: "it_managed_services", name: "IT managed services", nameAr: "خدمات تقنية المعلومات المُدارة", desc: "MSP, helpdesk, and infrastructure support.", category: "technology_software", archetype: "technology_and_saas", aliases: ["MSP", "managed IT", "IT support", "دعم تقني"] },
  ...
  // Cybersecurity
  { key: "cybersecurity_mssp", name: "Cybersecurity and MSSP", nameAr: "الأمن السيبراني", desc: "Security operations, SOC, and cyber consulting.", category: "cybersecurity_it_services", archetype: "technology_and_saas", aliases: ["MSSP", "SOC", "cyber security", "infosec", "أمن سيبراني"], misspellings: ["cybersecuirty"], regulated: "Security services often require segregation of duties.", ssic: "6202" },
  ...
  // Gaming
  { key: "game_development", name: "Game development", nameAr: "تطوير الألعاب", desc: "Game studios and interactive entertainment.", category: "gaming_esports", archetype: "technology_and_saas", aliases: ["game studio", "game dev", "ألعاب"] },
  ...
  // Automotive
  { key: "auto_repair_workshop", name: "Auto repair workshop", nameAr: "ورشة سيارات", desc: "Vehicle repair, maintenance, and body shops.", category: "automotive_services", aliases: ["garage", "auto shop", "mechanic", "ورشة"] },
  ...
  { key: "custom_specialist_activity", name: "Specialist activity (custom)", nameAr: "نشاط متخصص", desc: "Placeholder for ProCrow-reviewed custom descriptions.", category: "other_specialist_services", aliases: ["other", "specialist", "custom"] },
];

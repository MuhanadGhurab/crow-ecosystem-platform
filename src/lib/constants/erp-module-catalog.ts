...
export const ERP_MODULE_CATALOG: ErpModuleCatalogEntry[] = [
  ...
  },
  {
    ...
    category: "core_erp",
    shortDescription:
      "Executive and operational reporting readiness — cross-module roll-ups and advisory KPI signals.",
    businessPurpose:
      "Aggregate G2–G8 module readiness, task/workflow context, CyberCrow evidence posture, and SAREA experience signals into operator-reviewed executive visibility — no warehouse layer, external BI connectors, predictive engines, or certified compliance outputs.",
    primaryUsers: [
      "COO",
      "CFO",
      "Department head",
    ...
    relatedDepartments: ["Executive", "Finance", "Operations", "Compliance", "IT"],
    ownedDataExamples: [
      "KPI category readiness",
      "Executive roll-up status per domain",
      "Module health summaries (advisory)",
      "Task and workflow counts",
      "CyberCrow / SAREA posture summaries",
    ],
    commonWorkflows: [
      "Monthly executive review",
      "Module health review",
      "Finance readiness review",
      "CyberCrow evidence review",
      "SAREA role experience review",
    ],
    approvalNeeds: ["Publish executive snapshot (future-only)"],
    reportSignals: [
      "Cross-module KPI categories",
      "Executive roll-up healthy / needs review / limited data",
      "Open tasks and active workflows",
      "Pipeline SAR and open AR advisory totals",
      "CyberCrow initialized posture",
      "SAREA backed vs fallback personas",
    ],
    cyberCrowRisks: [
      "Export of sensitive KPIs without classification",
      "Evidence gaps misread as certified compliance",
      "Executive snapshot shared outside tenant boundary",
      SHARED_CYBER.access,
    ],
    evidenceExamples: [
      "Executive readiness snapshot review",
      "Report run advisory log (future export)",
      "Cross-module KPI acknowledgment",
      "CyberCrow evidence pack linkage",
    ],
    auditEvents: ["reports.snapshot.generated", "reports.rollup.reviewed"],
    sareaExperienceHints: [
      "Executive: low-density roll-up tiles",
      "CFO: finance and commercial sections first",
      "Analyst: table-forward signals with hub links",
      "Tenant admin: module enablement context",
    ],
    sectorRelevance: rel(
      ["logistics", "retail", "construction", "aviation", "healthcare"]
    ),
    ...
    dataSource:
      "reports.service + reports-bi-readiness.service + cem-operations-intelligence + module readiness snapshots",
    uiMaturityNotes:
      "G9 executive roll-up hub; module hubs link here when bi enabled; no fabricated charts",
    futureDepth: [
      "Custom dashboards (future-only)",
      "Scheduled email delivery (future-only)",
      "Export packs (future-only)",
    ],
    futureOnlyCapabilities: [
      "Data warehouse",

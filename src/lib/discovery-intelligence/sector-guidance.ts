...
const GUIDANCE: Record<SectorTemplateKey, SectorGuidance> = {
  ...
  healthcare: {
    ...
    headline: "Healthcare operations readiness",
    whyItMatters:
      "Clinics and healthcare networks need clear separation between patient services, front desk, care coordination, supplies, finance, and privacy — without implying Crow replaces an EMR/EHR or provides clinical advice.",
    focusAreas: [
      "Facility type and branch/clinic count",
      "Patient / customer service and escalation",
      "Appointment and front-desk coordination",
      "Staff scheduling and workforce requests",
      "Supplies and procurement",
      "Incident / safety and quality review",
      "Privacy / access review readiness",
      "Reporting and CyberCrow advisory posture",
    ],
    departmentHints: [
      "Separate Clinic / Healthcare Operations, Patient Services, Front Desk, and Nursing / Care Coordination — do not collapse into one generic clinical dept.",
      "Privacy / Compliance and Quality / Patient Safety serve different review paths; keep both when headcount supports it.",
      "Pharmacy / Supplies Readiness is for operational supplies coordination — not a live pharmacy system integration.",
      "Finance / Billing Coordination should exist before billing review workflows are marked in scope.",
      "Do not imply the platform stores live patient medical records or replaces clinical systems.",
    ],
    workflowExamples: [
      "Patient service request intake and patient issue escalation",
      "Appointment request coordination at front desk",
      "Supplies request and supplier purchase approval",
      "Incident / safety report with quality and privacy review paths",
      "Privacy access review and role / access change review",
      "Monthly healthcare operations report and CyberCrow incident review",
    ],
    securityHints: [
      "Capture whether an EMR/EHR or appointment system exists — Crow coordinates operations readiness; integrations are future-only unless explicitly scoped.",
      "Segment front desk, billing, and admin roles from clinical-facing staff in RBAC discussions — MFA for managers is a common operator policy.",
      "Patient identifiers in CRM/service workflows: minimize sensitive fields on screen; advisory privacy posture only.",
      "Do not claim HIPAA compliance, NPHIES integration, or live patient-data protection guarantees.",
    ],
    sareaHints: [
      "Executive / owner: operations health, open safety items, privacy posture — strategic density.",
      "Healthcare Operations Manager: workflows, service tasks, exceptions — control board.",
      "Clinic Manager and Front Desk: different nav — appointments vs escalations.",
      "Patient Service Agent: task-focused workspace — SAREA shapes experience, RBAC controls access.",
      "Quality / Safety and Privacy / Compliance reviewers need evidence-oriented dashboards, not frontline mobile UI.",
      "Analyst vs operations manager: reporting readiness vs live task boards.",
    ],
    cybercrowHints: [
      "Suggest access review, role-change abuse, patient data exposure, appointment manipulation, safety underreport, supplier abuse, billing gap, and branch access anomaly baselines when healthcare modules are confirmed.",
      "Evidence readiness examples: access review record, role change approval trail, patient service escalation record, appointment/request trail, incident/safety report, quality review record, supplier approval trail, finance/billing review, monthly operations report.",
      "Use privacy readiness, evidence readiness, and advisory posture language — not certified healthcare compliance, SIEM replacement, or autonomous AI detection as live capabilities.",
      "Do not claim HIPAA compliance, NPHIES integration, medical compliance certification, or clinical safety certification.",
    ],
    blueprintNotes: [
      "Recommended live modules: crm, sales (service intake), procurement, finance, hr, approvals (tasks), bi (reports).",
      "EMR/EHR, appointment systems, pharmacy systems, insurance, patient portal, lab systems, clinical decision support, and device telemetry are future readiness — document in blueprint notes, not as live modules.",
      "Blueprint should carry healthcare departments, roles, workflows, CyberCrow baselines, and SAREA profiles from org intelligence accept.",
      "Idempotent blueprint accept only — no automatic tenant provisioning.",
      "When industry is ambiguous, confirm facility type and sector on the request — avoid logistics hub, retail store, construction site, or aviation station defaults leaking into healthcare blueprints.",
    ],
  },
  retail: {
    sectorKey: "retail",

...
export function buildDiscoveryMvpWorkspaceModel(input: {
  ...
  return {
    ...
    d0d2ScopeNote:
      "D0–D4 foundation: safety, status mapping, adaptive Stages 1–3 fields, and local Operating Model input draft (pre-Blueprint). ProCrow modeling review (D5) and Blueprint handoff (D6) are not in this slice.",
  };
}

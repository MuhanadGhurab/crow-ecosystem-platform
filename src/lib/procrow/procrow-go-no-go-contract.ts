...
export function buildProCrowValidationCommandIndex(): ProCrowValidationCommand[] {
  ...
  return [
    ...
    { name: "ProCrow portal UX", command: "npm run procrow:verify", purpose: "ProCrow + CyberCrow + SAREA + go/no-go verifier chain.", riskLevel: ro, requiredForDemo: true, requiredForPush: true, requiredForProduction: true },

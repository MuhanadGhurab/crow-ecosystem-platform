...
1. Run automated a11y checks on Product UI (blocked — no Product Code).
2. Conduct manual expert review and AT testing.
3. Execute user validation sessions.
4. File ACCESSIBILITY-VALIDATION-REPORT.md.

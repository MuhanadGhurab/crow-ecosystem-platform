...
1. Configure backup policy on approved infrastructure.
2. Execute restore drill with integrity verification.
3. Measure RPO/RTO against draft targets.
4. File BACKUP-RESTORE-DRILL.md.

# Test Plan — Contact / Email / Mobile Verification
...
1. Obtain contact provider sandbox credentials.
2. Send test verification messages through adapter.
3. Confirm Delivery≠Verified invariant on provider responses.
4. File CONTACT-VERIFICATION-VALIDATION.md.

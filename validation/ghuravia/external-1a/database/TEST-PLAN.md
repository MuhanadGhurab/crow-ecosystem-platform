# Test Plan — Database / Datastore Host
...
1. Confirm Preview environment variables for database connectivity.
2. Provision approved disposable database instance per architecture datastore host pattern.
3. Execute schema contract validation against disposable DB.
4. Record readiness evidence in PREVIEW-DATABASE-READINESS-REPORT.md and DATABASE-CONTRACT-VALIDATION.md.

...
1. Obtain scanner vendor sandbox credentials.
2. Upload test corpus through adapter pipeline.
3. Validate fail-closed behaviour on scan failure/timeout.
4. File EVIDENCE-SCANNING-VALIDATION.md.

# Test Plan — Localization / Arabic UX
...
1. Review technical RTL implementation (SPK-002 spike reference).
2. Conduct native Arabic expert review.
3. Execute user validation sessions for typography and mixed-script.
4. File ARABIC-UX-VALIDATION-REPORT.md.

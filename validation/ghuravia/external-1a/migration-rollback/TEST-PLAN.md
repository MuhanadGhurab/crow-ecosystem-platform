...
1. Establish disposable database matching production host class.
2. Apply forward migration set under controlled rehearsal.
3. Execute rollback procedure and verify data integrity checkpoints.
4. File evidence in MIGRATION-ROLLBACK-REHEARSAL.md.

...
1. Obtain notification provider sandbox credentials.
2. Send test notifications across channels.
3. Verify failure↛business state invariant.
4. File NOTIFICATION-PROVIDER-VALIDATION.md.

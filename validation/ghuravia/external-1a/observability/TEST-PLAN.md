...
1. Obtain observability provider sandbox/project credentials.
2. Ingest test telemetry and validate cardinality/cost guards.
3. Confirm telemetry≠audit≠progression separation.
4. File OBSERVABILITY-PROVIDER-VALIDATION.md.
